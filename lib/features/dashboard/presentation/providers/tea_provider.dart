...
final teaProductsProvider = FutureProvider<List<TeaHiveModel>>((ref) async {
  final hiveService = ref.read(hiveServiceProvider);
  final teas = await hiveService.getAllTeaProducts();
  // Only show available teas
  return teas.where((t) => t.isAvailable).toList();
});
